...
main() {
  ...
  test("getSubmitAnsModel Test, Should return 2",(){
    ...
    var questionList = [
      QuestionModel(question: "Test Question 1",options: [Answers(name: "Optioin 1",skillId: "123")],skillId: "123",selectedAnswers: [Answers(name: "Optioin 1",skillId: "123")]),
      QuestionModel(question: "Test Question 1",options: [Answers(name: "Optioin 1",skillId: "123")],skillId: "123",selectedAnswers: [Answers(name: "Optioin 1",skillId: "123")]),
    ];
  ...
  test("getSortedAnsListInInteger Test, giving [3,1]  Should return [1,3]",(){
    ...
    List<int> actualValue =  submitProvider.getSortedAnsListInInteger(QuestionModel(selectedAnswers: [Answers(skillId: "3",name: "data"),Answers(skillId: "1",name: "data")]));
