...
import 'package:skill_check/main_app/widgets/button_with_primary_fill_color.dart';
import 'package:skill_check/main_app/widgets/edit_screen_save_button.dart';
import 'package:skill_check/main_app/widgets/rectangular_button.dart';
  ...
  _handleSave() {
    ...
    if (isSuccess) {
      ...
      if(education == null || index == null){
        education.profSkillId = Uuid().v1();
        addEditEducationProvider.addData(context, education);
      }else{
        education.profSkillId = educationModel.profSkillId;
