...
class _MessageScreenState extends State<MessageScreen> with AfterLayoutMixin {
  ...
  MessageSenderListScreenViewModel notiVM;

  @override
  void initState() {
    Get.put(MessageSenderListScreenViewModel());
    notiVM = Get.find<MessageSenderListScreenViewModel>();
...
//      drawer: AppDrawer(),
      body: GetBuilder<MessageSenderListScreenViewModel>(builder: (vm)=>PageStateBuilder(
